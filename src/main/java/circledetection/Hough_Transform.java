...
// origin: https://github.com/taigner/circle-detection
...
// hhr: added setParameters, runHeadless
...
//        return edges;
    ...
    private void findAndDrawCircles() {
        final int[][] results = findCircles();
    ...
    public int[][] findCircles() {
        ...
        final int maximumNumberOfCircles = numberOfSearchResults;
    ...
    public void setParameters(int radiusMin, int radiusMax, int numberOfSearchResults) {
    ...
    // added hhr
    public int[][] runHeadless(ImageProcessor imageProcessor) {
        original = imageProcessor;
